...
class GameManager:
    def __init__(self):
        ...
        self.positions = []
        self.GAME_TITLE = "Whack A Zombie - Game Programming - Assignment 1"
    ...
    def endScreen(self):
        ...
        while loop:
            ...
            score_text_pos = score_text.get_rect()
            score_text_pos.centerx = self.background.get_rect().centerx
            score_text_pos.centery = self.FONT_TOP_MARGIN*5
            self.screen.blit(score_text, score_text_pos)
            # Update the player's misses
            current_misses_string = "MISSES: " + str(self.misses)
            ...
            misses_text_pos.centery = self.FONT_TOP_MARGIN*8
            self.screen.blit(misses_text, misses_text_pos)
            # Update the player's level
            current_level_string = "LEVEL: " + str(self.level)
            ...
            level_text_pos.centery = self.FONT_TOP_MARGIN*11
            self.screen.blit(level_text, level_text_pos)
            ...
            gameover_text_pos.centery = self.FONT_TOP_MARGIN*2
            ...
            continue_text_pos.centery = self.FONT_TOP_MARGIN*15
